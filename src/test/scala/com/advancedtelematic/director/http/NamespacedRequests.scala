...
//
//  def registerDeviceOkWith(regDev: RegisterDevice, withRoutes: Route)(implicit ns: NamespaceTag, pos: Position): Unit =
...
//
//  def getInstalledImagesOkWith(device: DeviceId, withRoutes: Route)(implicit ns: NamespaceTag, position: Position): Seq[(EcuIdentifier, Image)] =
...
//    }
//
//  def cancelDevices(devices: DeviceId*)(implicit ns: NamespaceTag, pos: Position): Seq[DeviceId] =
